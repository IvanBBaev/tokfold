...
//! [`mod@format`] archive framing — behind a small, sans-io, synchronous
//! surface.
//!
...
//! `decode_full` pattern in [`mod@format`] and lets
...
pub struct Stats {
    ...
    /// Id of the estimator that drove selection. Reported here rather than written
    /// into the archive, whose header always records `0`.
